...
- **漏洞发现**：[Liu et al., 2026](https://arxiv.org/abs/2601.10338)（USENIX Security 2026 收录）分析 31,132 个技能（收集自 42,447），发现 26.1% 含至少一个漏洞；含可执行脚本的技能漏洞率高 2.12×。
- **可利用性验证**：[SkillAttack](https://arxiv.org/abs/2604.04989)（Duan et al., 2026）通过对抗性 prompting 验证，100 个真实技能上攻击成功率高达 26%。
- **供应链投毒**：[Qu et al., 2026](https://arxiv.org/abs/2604.03081) 提出 DDIPE 攻击——将恶意逻辑藏于技能文档的代码示例与配置模板，代理复用示例时即触发，绕过率 11.6%–33.5%。单个恶意技能可凭系统级权限危及宿主，技能已成为新兴软件供应链攻击面。
