...
> writing-skill-md 人类作者参考：`authoring/tdd-validation.md` 的“对抗合理化”与 REFACTOR 封堵手法的完整参考表。SKILL.md 不展开此主题；需要借口对照表、完整封堵手法、合理化表与红旗清单模板时读本文件。
...
```yaml
description: 强制执行测试优先流程。在实现任何功能或修复 bug 时、编写实现代码前使用
```
...
| 编号 | 文件路径 | 用途 |
|------|---------|------|
| [L1] | ./persuasion-principles.md | 说服原则心理学基础研究 |
