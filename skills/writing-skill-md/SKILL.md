...
description: 指导 SKILL.md 的创建与格式——技能类型、YAML 前置元数据、CSO、渐进式披露、反模式与自检。在创建新技能、编辑现有技能或部署前验证时使用。
license: Apache-2.0
---
...
技能直接注入代理上下文，恶意或脆弱的技能可导致数据窃取、权限提升等风险。大规模实证分析（Liu et al., 2026，4 万+ 技能）发现 26.1% 含至少一个漏洞；SkillAttack（[arXiv:2604.04989](https://arxiv.org/abs/2604.04989)）进一步通过对抗性 prompting 验证可利用性，在 100 个真实技能上攻击成功率高达 26%。
