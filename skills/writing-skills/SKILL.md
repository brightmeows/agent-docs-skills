...
**必须先激活 [`writing-agent-docs`](../writing-agent-docs/SKILL.md)**——代理文档写作的通用规则。本技能仅承载 SKILL.md 专属内容（TDD、技能类型、CSO、三级渐进式披露、对抗合理化），不重复通用规则。

**还需理解 [test-driven-development](../test-driven-development/SKILL.md)**——基本的 RED-GREEN-REFACTOR 循环；本技能将 TDD 适配到文档领域。
